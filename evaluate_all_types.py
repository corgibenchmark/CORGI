...
# sys.path.insert(0, '/path/to/rebuttal')  # Uncomment and set your path
# project_root = "/path/to/project"  # Uncomment and set your project root
...
# Set OPENROUTER_API_KEY as an environment variable or in .env file
...
def load_notebook_code():
    ...
    # Note: Update this path to point to your notebook file
    notebook_path = 'agent_eval.ipynb'  # Update with your actual notebook path if different
